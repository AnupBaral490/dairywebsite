...
urlpatterns = [
    ...
    path('farmers/<int:pk>/', views.farmer_detail, name='farmer-detail'),
    path('farmers/<int:pk>/contact/', views.contact_farmer, name='contact-farmer'),
    ...
    path('checkout/', views.show_cart, name='show_cart'),
    path('checkout/process/', views.checkout.as_view(), name='checkout'),
